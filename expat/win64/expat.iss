...
UninstallDisplayName=Expat XML Parser {#expatVer}{#var}
VersionInfoVersion={#expatVer}
ArchitecturesAllowed=x86 x64
ArchitecturesInstallIn64BitMode=x64
OutputBaseFilename=expat-win64bin-{#expatVer}
...
[Files]
Flags: ignoreversion; Source: win64\bin\Release\xmlwf.exe;  DestDir: "{app}\Bin"
Flags: ignoreversion; Source: win64\MANIFEST.txt;           DestDir: "{app}"
...
Flags: ignoreversion; Source: win64\bin\Release\*.dll;      DestDir: "{app}\Bin"
Flags: ignoreversion; Source: win64\bin\Release\*.lib;      DestDir: "{app}\Bin"
Flags: ignoreversion; Source: expat.sln;                    DestDir: "{app}\Source"
Flags: ignoreversion; Source: win64\README.txt;             DestDir: "{app}\Source"
